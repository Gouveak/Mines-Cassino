...
if (caixaSaldoEl) { // o saldo armazenado como variável global substituirá o texto inicial do h2
  if (saldoAtual) {
...
if (caixaApostaEl) { // o valor da aposta é imprimido; caso o usuário feche ou recarregue a aba sem querer, o valor será mantido
  caixaApostaEl.innerHTML = `$ ${valorAposta}`;
}

function apostar(valorFicha) { // caso o saldo seja suficiente, o valor da ficha será acumulado em aposta, e descontado de saldo
...
document.getElementById("btn-apostar-cinquenta").addEventListener("click", () => {
  apostar(50);
});
